...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <a href="<?php echo $base; ?>/profissionais/listar.php" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo $base; ?>/empresas/listar.php" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo $base; ?>/contratos/listar.php" class="text-decoration-none">
            <div class="card text-center h-100">
                <div class="card-body py-4">
